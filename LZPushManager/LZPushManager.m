...
- (void)saveInstallationWithDeviceToken:(NSData *)deviceToken {
    ...
    [currentInstallation setDeviceProfile:@"renaihealth_user_client"];
    ...
    if([AppDelegate getCurrentLogonUser].userId){
        [currentInstallation addUniqueObject:[NSString stringWithFormat:@"user_%@",[AppDelegate getCurrentLogonUser].userName] forKey:kAVIMInstallationKeyChannels];
    }
